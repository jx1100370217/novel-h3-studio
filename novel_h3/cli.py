...
def configure(root):
    ...
    write(Path(root) / "config.json", {
        ...
        "fastvideo": {"model_filename": "fastvideo_fasth3_8step_v2_pruned_int8_convrot.safetensors",
                      "model_variant": "int8_convrot", "production_enabled": False,
                      "input_mode": "fl2va", "scheduler_shift_video": 10.0,
                      "scheduler_shift_audio": 3.0,
                      "compatibility_note": "FastVideo/FastVideo-FastH3-8-Step-V2 的 ComfyUI 单文件兼容权重；仅用于隔离速度基准。"},
        ...
        "blender_previs": {"enabled": True, "binary": "", "width": 512, "height": 288,
                            "fps": 24, "threads": 2,
                            "purpose": "无声白模视频作为 H3 Ref2VA 空间、站位与运镜参考"},
